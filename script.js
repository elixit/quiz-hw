...
function gotoNext() {
    questionTitle.textContent = questions[questionStorage].question; // function accesses questionstorage for choice input
...
function checkAnswer(answer) { // function checks to see if answer is correct
...
function chooseA() { checkAnswer(0); } // function assigns correct buttons to correct function
...
function storeHighScores(event) { // function stores the high scores
